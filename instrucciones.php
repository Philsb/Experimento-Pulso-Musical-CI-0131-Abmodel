...
<head>
  ...
  <title>Prueba de Memoria Rítmica</title>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8" data-aos="fade-up" data-aos-delay="100">
                        <div class="icon-box" data-aos="zoom-in" data-aos-delay="100">
                            ...
                            <p class="description mobile-button">Los audios solo se reproducirán una sola vez por 8 segundos. Durante este tiempo no se registran pulsaciones del usuario, utilice este tiempo para acostumbrarse al ritmo. Luego de que termine de escuchar el audio, continue presionando el botón en pantalla, intentando mantener el mismo ritmo, hasta que el tiempo en pantalla llegue a cero.</p>
                        </div>
                    </div>
                    <div class="col-lg-2">
                    </div>
